...
@tf.keras.saving.register_keras_serializable(package="NucleotideEncoderV3")
class NucleotideEncoderV3(tf.keras.Model):
    def __init__(
        self,
        embedding_dim: int,
        max_bp: int,
        ...
        **kwargs,
        ...
        super(NucleotideEncoderV3, self).__init__(**kwargs)
    ...
    def build(self, input_shape):
        ...
        super(NucleotideEncoderV3, self).build(input_shape)

    def compile(self, include_bert_loss=True, **kwargs):
        super(NucleotideEncoderV3, self).compile(**kwargs)
    ...
    def get_config(self):
        config = super(NucleotideEncoderV3, self).get_config()
