...
from keras.src.layers import activation, core, regularization
...
class MultiHeadAttention(Layer):
    ...
    def _make_output_dense(self, free_dims, common_kwargs, name=None):
        ...
        einsum_equation, bias_axes, output_rank = _build_proj_equation(free_dims, bound_dims=2, output_dims=len(output_shape))
    ...
    def _construct_bias(self, inputs):
    ...
    def _softmax(self, inputs, mask=None):
        ...
        inputs += self._construct_bias(inputs)
        return tf.keras.backend.softmax(inputs, axis=-1)
