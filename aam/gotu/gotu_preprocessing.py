...
class FormatBiomTables:
    ...
    def __init__(
        ...
        try:
            ...
            IOError,
            ValueError,
        ) as e:  # Assuming biom.load_table throws these on errors
    ...
    def sort_and_filter_biom(
        self,
    ) -> Tuple[biom.table.Table, biom.table.Table]:
        """
    ...
    def order_biom(
        self,
        gotu_table_intersect: biom.table.Table,
        asv_table_intersect: biom.table.Table,
    ) -> Tuple[biom.table.Table, biom.table.Table]:
        """
        ...
        gotu_ordered_table = gotu_table_intersect.sort_order(
            gotu_obs_ordered, axis="observation"
        )
        asv_ordered_table = asv_table_intersect.sort_order(
            asv_obs_ordered, axis="observation"
        )
