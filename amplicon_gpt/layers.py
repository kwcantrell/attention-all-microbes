...
class MultiHeadPCAProjection(tf.keras.layers.Layer):
    def build(self, input_shape):
        ...
        first_transp = first_transp[:-3] + [first_transp[-2], first_transp[-3], first_transp[-1]]
        ...
        self.compute_proj = MultiHeadPCAProjection.init_proj(reshape, tf.constant(emb_shape - 1, dtype=tf.float32), first_transp, second_transp)
